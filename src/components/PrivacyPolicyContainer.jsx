                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="privacy-policy">
                            <h1>{t("Protection des données")}</h1>
                            ...
                            <div className="item-privacy">
                                ...
                                <p>Wir hosten unsere Website bei IONOS SE. Anbieter ist die IONOS SE, Elgendorfer Str. 57, 56410 Montabaur (nachfolgend IONOS). Wenn Sie unsere Website besuchen, erfasst IONOS verschiedene Logfiles inklusive Ihrer IP-Adressen. Details entnehmen Sie der Datenschutzerklärung von IONOS: 
                                    <a target='_blank' href='https://www.ionos.de/terms-gtc/terms-privacy'>https://www.ionos.de/terms-gtc/terms-privacy</a>.
                                </p>
                            ...
                            <div className="item-privacy">
                                ...
                                <p>Weitere Informationen zu Google Web Fonts finden Sie unter <a href="https://developers.google.com/fonts/faq" target='_blank'>https://developers.google.com/fonts/faq</a> und in der Datenschutzerklärung von Google: <a target='_blank' href="https://policies.google.com/privacy?hl=de">https://policies.google.com/privacy?hl=de</a>.</p>
